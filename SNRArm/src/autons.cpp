...
void rushmid(){
  ...
  chassis.set_drive_constants(12, 1, 1, 10, 0);
  Intake.spin(forward);
...
void solosig(){
  ...
  wait(0.2, seconds);
  chassis.drive_distance(8.5, 90);
  chassis.set_drive_constants(12, 1.5, 0, 10, 0);
  chassis.set_turn_exit_conditions(1, 300, 600);
  chassis.turn_to_angle(211);
  chassis.set_drive_constants(12, 1.5, 0, 10, 0);
  chassis.set_drive_exit_conditions(1.5, 300, 650);
  chassis.drive_distance(-18.5, 211.5);
  chassis.set_drive_constants(6.5, 1.5, 0, 10, 0);
  chassis.set_drive_exit_conditions(1.5, 300, 500);
  chassis.drive_distance(-10, 210.5);
  chassis.set_drive_constants(12, 1.5, 0, 10, 0);
  thread(ArmDown).detach();
  wait(0.43, seconds);
  ...
  chassis.turn_to_angle(-91+d); //-75+d
  chassis.set_drive_constants(12, 1.2, 0, 10, 0);
  chassis.set_drive_exit_conditions(1.5, 300, 800);
  Intake.spin(forward);
  Conveyer.spin(forward);
  //IntakeFront.spin(forward);
  chassis.drive_distance(20.2, -91+d); // 23.2,-75+d
  //wait(0.2, seconds);
  //wait(0.5, seconds);
  //below is for going to corner
  // chassis.left_swing_to_angle(-23+d);
  ...
  chassis.set_drive_exit_conditions(1.5, 300, 1040);

  chassis.drive_distance(39.6);
  chassis.turn_to_angle(206.6+d);
  //chassis.set_drive_exit_conditions(1.5, 300, 550);
  //chassis.drive_distance(-12, 180+d);
  chassis.set_drive_constants(6.5, 1.2, 0, 10, 0);
  chassis.set_drive_exit_conditions(1.5, 300, 770);
  MogoPneu.set(false);
  ...
  chassis.turn_to_angle(76+d); //-70+d
  thread(ArmUp).detach();
  chassis.set_drive_constants(12, 1.2, 0, 10, 0);
  chassis.set_drive_exit_conditions(1.5, 300, 800);
  //IntakeFront.spin(forward);
